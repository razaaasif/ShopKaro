...
-- Schema shopkaro
-- -----------------------------------------------------
DROP SCHEMA IF EXISTS `shopkaro`;

CREATE SCHEMA `shopkaro`;
USE `shopkaro` ;

-- -----------------------------------------------------
-- Table `shopkaro`.`product_category`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `shopkaro`.`product_category` (
...
-- -----------------------------------------------------
-- Table `shopkaro`.`product`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `shopkaro`.`product` (
  `id` BIGINT(20) NOT NULL AUTO_INCREMENT,
